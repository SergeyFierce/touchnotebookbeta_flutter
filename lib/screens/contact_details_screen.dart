...
class _ContactDetailsScreenState extends State<ContactDetailsScreen> with RouteAware {
  ...
  Widget _reminderTagChip(int count) {
    ...
    return Chip(
      ...
      backgroundColor: _tagColor('Напомнить'),
  ...
  void initState() {
    ...
    _contact = widget.contact.copyWith(
      tags: widget.contact.tags.where((tag) => tag != 'Напомнить').toList(),
    );
    _loadFromContact();
    _loadReminders();
    _loadNotes();
  ...
  Contact _snapshot() => Contact(
    ...
    tags: _tags.where((tag) => tag != 'Напомнить').toList(),
  ...
  void _loadFromContact() {
    ...
    _tags
      ..clear()
      ..addAll(c.tags.where((tag) => tag != 'Напомнить'));
